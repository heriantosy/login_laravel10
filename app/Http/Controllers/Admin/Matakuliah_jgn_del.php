    ...
    public function proses(Request $request)
    {
        ...
        // PROSES SETTING DRAFT
            ...
            if($request->prodi=='' || $request->kurikulum==''){
                ...
                return redirect('admin/matakuliah/filter/'.$request->kurikulum.'/'.$request->prodi);
            }
        }
    }

    // Main page
    public function filter($kurikulum,$prodi) //posisi kurikulum dan prodi jangan terbalik diambil dari return redirect function proses
    {
        
        $kurikulumx      = $kurikulum;
        $prodix      = $prodi;
       
        $matakuliah = DB::table('mk')
                    ->join('kurikulum', 'kurikulum.KurikulumID', '=', 'mk.KurikulumID')
                    ->select('mk.*', 'kurikulum.Nama as NamaKurikulum')
                    ->where('mk.KurikulumID',$kurikulumx)
        ...
        $data = array(  'title'         => 'Data kurikulum: '.$kurikulumx.' Program Studi: '.$prodix,
                        'matakuliah'    => $matakuliah,
                        'kurikulum'     => $kurikulum,
                        'prodi'         => $prodi,
