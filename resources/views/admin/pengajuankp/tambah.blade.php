...
@endif
<form action="{{ asset('admin/pengajuankp/tambah_proses') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
 {{ csrf_field() }}
...
<div class="form-group row">
  ...
  <div class="col-sm-8">
    <input type="text" name="KelompokID" class="form-control form-control-sm" placeholder="Nama Kelompok" value="<?php if(isset($_POST['NamaKelas'])) { echo old('NamaKelas'); } ?>">
  </div>
</div>

<div class="form-group row">
  <label class="col-sm-4 control-label text-right">Ketua Kelompok <span class="text-danger">*</span></label>
  <div class="col-sm-8">
...
<div class="form-group row">
  ...
  <div class="col-sm-8">
  <textarea name="Judul" rows="4" class="form-control form-control-sm" placeholder="Judul Kerja Praktek" ></textarea>
  </div>
</div>
...
<div class="form-group row">
  <label class="col-sm-4 control-label text-right">Deskripsi <span class="text-danger">*</span></label>
  <div class="col-sm-8">
    <input type="text" name="Deskripsi" class="form-control form-control-sm" placeholder="Deskripsi" value="<?php if(isset($_POST['NamaKelas'])) { echo old('NamaKelas'); } ?>">
  </div>
</div>
