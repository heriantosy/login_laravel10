...
@endif
<form action="{{ asset('admin/konsentrasi/tambah_proses') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
 {{ csrf_field() }}
...
<div class="form-group row">
  <label class="col-sm-2 control-label text-left">Kode Konsentrasi<span class="text-danger"> *</span></label>
  <div class="col-sm-4">
    <input type="text" name="KonsentrasiKode" class="form-control form-control-sm" placeholder="KonsentrasiKode" value="55">
  </div>
</div>
