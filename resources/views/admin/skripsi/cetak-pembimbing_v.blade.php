...
<br>
      ...
      <td width="90"></td>
      <td width="1"></td>
      <td width="150" colspan="3">Kepada<br> Yth. Bapak/Ibu <?php echo $pembimbing1->Nama ?>, <?php echo $pembimbing1->Gelar ?>
      <br> Dosen Pembimbing I (Utama) Skripsi <br>Program Studi <?php echo $prodi->Nama ?><br></td>
      </tr>
      </table>
      <br>
