...
<form action="{{ asset('admin/skripsinilai/proses_nilai') }}" method="post" accept-charset="utf-8">
  {{ csrf_field() }}
...
?>
  ...
  <tr style='font-size:15px;'>
    ...
    <td style='text-align:center'><?php echo $r->NilaiPengujiSkripsi1 ?></td>
    <td style='text-align:center'><?php echo $r->NilaiPengujiSkripsi2 ?></td>
    <td style='text-align:center'><?php echo $r->NilaiPengujiSkripsi3 ?></td>
