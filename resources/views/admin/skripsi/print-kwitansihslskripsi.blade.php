...
if ($ProdiID=='SI'){ $prod="Sistem Informasi"; $kaprodi="Herianto, S.Kom, M.Kom";}else{ $prod="Teknik Informatika"; $kaprodi="Yuda Irawan, S.Kom, M.TI";}
  ...
  $p1 = DB::table('dosen')->where('Login',$jadwal->PembimbingPro1)->first();
  if(!empty($p1->Nama)){
  ...
  $p2 = DB::table('dosen')->where('Login',$jadwal->PembimbingPro2)->first();
  if(!empty($p2->Nama)){
  ...
  $Pji1 = DB::table('dosen')->where('Login',$jadwal->PengujiSkripsi1)->first();
  if(!empty($Pji1->Nama)){
  ...
  //Penguji 2 ---------------------------------------------
  $Pji2 = DB::table('dosen')->where('Login',$jadwal->PengujiSkripsi2)->first();
  if(!empty($Pji2->Nama)){
  ...
  //Penguji 3 ---------------------------------------------
  $Pji3 = DB::table('dosen')->where('Login',$jadwal->PengujiSkripsi3)->first();
  if(!empty($Pji3->Nama)){
...
$honorpmb     = DB::table('t_biaya')->where('BiayaID','6')->first();									 
$nx 		      =$honorpmb->Jumlah;
$Nominalx     =terbilang($nx);
$ox 		      =$honorpmb->Jumlah;
$NominalPembimbing =terbilang($ox);
...
<td style="border:none;padding:2px">Rp. <?php echo  number_format($nx) ?></td>
</tr>

<tr   style="border:none;padding:2px">
<td style="border:none;padding:2px;font-style:italic;">Terbilang</td>
<td style="border:none;padding:2px">:</td>
<td style="border:none;padding:2px;font-style:italic;"><textarea rows="2" cols="70"><?php echo $NominalPembimbing ?> rupiah </textarea></td>
</tr>

<tr  style="border:none;padding:2px">
<td style="border:none;padding:2px">Untuk pembayaran</td>
<td style="border:none;padding:2px">:</td>
<td style="border:none;padding:2px">Honor Pembimbing Skripsi Tahun <?php echo $jadwal->TahunID ?></td>
</tr>
...
<tr style="border:none;padding:2px" >
  <td style="border:none;padding:2px;text-align:center">Zupri Henra Hartomi, M.Kom</td>
<td style="border:none;padding:2px;text-align:center">Hendry Fonda, M.Kom</td>
<td style="border:none;padding:2px;text-align:center"><?php echo $Pembimbing2 ?>, <?php echo $GelarPm2 ?></td>
</tr>
<tr  style="border:none;padding:2px">
  <td style="border:none;padding:2px" >&nbsp;</td>
  <td style="border:none;padding:2px" >&nbsp;</td>
...
<td style="border:none;padding:2px">Untuk pembayaran</td>
<td style="border:none;padding:2px">:</td>
<td style="border:none;padding:2px">Honor Penguji Ujian Hasil Skripsi Tahun <?php echo $jadwal->TahunID ?></td>
</tr>
