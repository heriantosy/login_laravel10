        ...
        <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <a href="/histori-konsultasi" class="m-0 font-weight-bold text-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Ibu Hamil</label>
                        <label for="inputEmail3" class="col-form-label">:</label>
                        <label for="inputEmail3" class="col-sm-5 col-form-label">{{ $ibuhamil[0]->nama_ibu }}</label>
                    </div>
                    <div class="row mb-3">
