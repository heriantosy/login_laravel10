<button type="button" class="btn btn-danger " data-toggle="modal" data-target="#delete{{ $konsul->id_konsul }}">
    <i class="fas fa-trash-alt"></i>
</button>


<div class="modal fade" id="delete{{ $konsul->id_konsul }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <form action="/konsultasi/hapus/{{ $konsul->id_konsul }}" method="post" class="d-inline">
