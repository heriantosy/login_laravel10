                            ...
                            <div class="form-group">
                                <select name="ibuhamil_id" id="ibuhamil_id" class="select2 form-control " style="width: 100%">
                                    ...
                                    @foreach ($ibuhamil as $item)
                                        <option value="{{ $item->id_ibuhamil }}">{{ $item->nama_ibu }}</option>   
                                    @endforeach
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                is-invalid @enderror" id="keluhan"
                                    placeholder="Masukkan Keluhan" name="keluhan" value="{{ old('keluhan') }}" >
                                    @error('keluhan')    
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                is-invalid @enderror" id="tekanan_darah"
                                    placeholder=".. mmHg" name="tekanan_darah" value="{{ old('tekanan_darah') }}" >
                                    @error('tekanan_darah')    
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                is-invalid @enderror" id="berat_badan"
                                    placeholder=".. Kg" name="berat_badan" value="{{ old('berat_badan') }}" >
                                    @error('berat_badan')    
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                is-invalid @enderror" id="umur_kehamilan"
                                    placeholder=".. Minggu" name="umur_kehamilan" value="{{ old('umur_kehamilan') }}" >
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                is-invalid @enderror" id="tinggi_fundus"
                                    placeholder=".. Cm" name="tinggi_fundus" value="{{ old('tinggi_fundus') }}" >
                                    @error('tinggi_fundus')    
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                is-invalid @enderror" id="letak_janin"
                                    placeholder="Kep/Su/Li" name="letak_janin" value="{{ old('letak_janin') }}" >
                                    @error('letak_janin')    
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                is-invalid @enderror" id="hasil_lab"
                                    placeholder="Masukkan Hasil laboratorium" name="hasil_lab" value="{{ old('hasil_lab') }}" >
                                    @error('hasil_lab')    
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                is-invalid @enderror" id="tindakan"
                                    placeholder="pemberian TT/ Fe/ terapi/ rujukan/ umpan balik" name="tindakan" value="{{ old('tindakan') }}" >
                                    @error('tindakan')    
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                is-invalid @enderror" id="nasihat"
                                    placeholder="masukkan nasihat" name="nasihat" value="{{ old('nasihat') }}" >
                                    @error('nasihat')    
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                is-invalid @enderror" id="keterangan"
                                    placeholder="tempat pelayanan/ nama pemeriksa/ paraf" name="keterangan" value="{{ old('keterangan') }}" >
                                    @error('keterangan')    
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                is-invalid @enderror" id="kpn_kembali"
                                    placeholder="masukkan kapan harus kembali" name="kpn_kembali" value="{{ old('kpn_kembali') }}" >
                                    @error('kpn_kembali')    
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
