<?php if($krs) { ?>  
<form action="{{ asset('admin/nilaieditmhs/proses') }}" method="post" accept-charset="utf-8">
  {{ csrf_field() }}
<input type="hidden" name="pengalihan" value="{{ url()->full() }}">
<div class="row">
  <div class="input-group mb-3 col-md-4">
  <a href="{{ asset('admin/nilaieditmhs/tambah/'.$tahunplh.'/'.$MhswIDplh) }}" class="btn btn-success btn-sm">
...
<tbody>
  ...
  <tr style='font-size:15px;'>
    ...
    <td> 
      <div class="btn-group">
      <a href="{{ asset('admin/nilaieditmhs/edit/'.$row->KRSID.'/'.$row->MhswID) }}"><i class="fa fa-edit"></i></a>
      </div>
    </td>
  </tr>
  <?php  }//End looping?>
