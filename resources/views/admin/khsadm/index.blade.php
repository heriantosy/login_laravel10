<p class="text-right">
  <a href="{{ asset('admin/khsadm/cetak_khs_v/'.$tahunplh.'/'.$MhswIDplh) }}" target="_BLANK" class="btn btn-success btn-sm">
...
<?php if($khs) { ?>  
<form action="{{ asset('admin/khsadm/proses') }}" method="post" accept-charset="utf-8">
  {{ csrf_field() }}
