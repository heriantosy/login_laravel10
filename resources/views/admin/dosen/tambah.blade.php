                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                is-invalid @enderror" id="nama_mahasiswa"
                                    placeholder="John" name="nama_mahasiswa" value="{{ old('nama_mahasiswa') }}" >
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="float-right">
                                <a href="/mahasiswa"  class="btn btn-danger"><i class="fas fa-times"></i> batal</a>
