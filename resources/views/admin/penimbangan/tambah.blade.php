    ...
    <div class="row">
        <div class="col-lg-12">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="/penimbangan/store" method="post">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                is-invalid @enderror" id="tanggal"
                                    placeholder="tanggal penimbangan" name="tanggal" value="{{ old('tanggal') }}" >
                                    @error('tanggal')    
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                is-invalid @enderror" id="tinggi_badan"
                                    placeholder="... cm" name="tinggi_badan" value="{{ old('tinggi_badan') }}" >
                                    @error('tinggi_badan')    
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                <input type="text" class="form-control @error('lingkar_kepala')
                                is-invalid @enderror" id="lingkar_kepala"
                                    placeholder="... cm" name="lingkar_kepala" value="{{ old('lingkar_kepala') }}" >
