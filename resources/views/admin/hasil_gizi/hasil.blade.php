...
<div class="container-fluid" id="container-wrapper">
    ...
    @if(empty($balita[0]->saran))
    <a href="/penimbangan/saran_edit/{{ $balita[0]->id_timbang }}" class="btn btn-primary mb-2">Beri saran</a>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h3 class="mx-auto font-weight-bold text-primary text-center">Saran dari Posyandu </h3>
                </div>
                <!-- Area Chart -->
                <div class="card-body mx-auto">
                    @foreach($balita as $b)
                    @if (empty($b->saran))
                        <h2>Tidak Ada Saran</h2>
                    @else
                        <h2>{{ $b->saran }}</h2>
                    @endif
