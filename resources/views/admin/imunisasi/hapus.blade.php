<button type="button" class="btn btn-danger " data-toggle="modal" data-target="#delete{{ $imun->id_imunisasi }}">
    <i class="fas fa-trash-alt"></i>
</button>


<div class="modal fade" id="delete{{ $imun->id_imunisasi }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <form action="/imunisasi/hapus/{{ $imun->id_imunisasi }}" method="post" class="d-inline">
