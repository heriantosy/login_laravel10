...
<form action="{{ asset('admin/tahun/edit_proses') }}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
{{ csrf_field() }}
...
<div class="row form-group">
  ...
  <div class="col-md-8">
    <input type="text" name="TahunID" class="form-control form-control-sm" placeholder="Tahun Akademik" required="required" value="<?php echo $tahun->TahunID ?>">
  </div>
</div>
...
<div class="row form-group">
  ...
  <div class="col-md-8">
    <input type="text" name="Nama" class="form-control form-control-sm" placeholder="Nama Tahun" value="<?php echo $tahun->TahunID ?>">
  </div>
</div>
...
<div class="row form-group">
  ...
  <div class="col-md-8">
    <input type="text" name="TglKRSMulai" class="form-control tanggal form-control-sm" placeholder="Mulai KRS" value="<?php echo date('d-m-Y', strtotime($tahun->TglKRSMulai)) ?>">
  </div>
</div>
...
<div class="row form-group">
  ...
  <div class="col-md-8">
    <input type="text" name="TglKRSSelesai" class="form-control tanggal form-control-sm"  value="<?php echo date('d-m-Y', strtotime($tahun->TglKRSSelesai)) ?>">
  </div>
</div>
...
<div class="row form-group">
  ...
  <div class="col-md-8">
    <input type="text" name="TglAkhirKSS" class="form-control tanggal form-control-sm" placeholder="Akhir Cetak KSS-KRS" value="<?php echo date('d-m-Y', strtotime($tahun->TglAkhirKSS)) ?>">
  </div>
</div>
...
<div class="row form-group">
  ...
  <div class="col-md-8">
    <input type="text" name="TglKRSOnlineMulai" class="form-control tanggal form-control-sm" placeholder="Mulai KRS" value="<?php echo date('d-m-Y', strtotime($tahun->TglKRSOnlineMulai)) ?>">
  </div>
</div>
...
<div class="row form-group">
  ...
  <div class="col-md-8">
    <input type="text" name="TglKRSOnlineSelesai" class="form-control tanggal form-control-sm"  value="<?php echo date('d-m-Y', strtotime($tahun->TglKRSOnlineSelesai)) ?>">
  </div>
</div>
...
<div class="row form-group">
  ...
  <div class="col-md-8">
    <textarea name="Catatan" class="form-control form-control-sm" ><?php echo $tahun->Catatan ?></textarea>
