...
<form action="{{ asset('admin/jnskurikulum/edit_proses') }}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
{{ csrf_field() }}
<input type="hidden" name="_token" value="{{csrf_token()}}">
<input type="hidden" name="JenisKurikulumID" value="<?php echo $jeniskurikulum->JenisKurikulumID ?>">
...
<div class="row form-group">
  ...
  <div class="col-md-8">
    <input type="text" name="Singkatan" class="form-control form-control-sm" placeholder="Singkatan" value="<?php echo $jeniskurikulum->Singkatan ?>">
...
<div class="row form-group">
  ...
  <div class="col-md-8">
    <input type="text" name="Nama" class="form-control form-control-sm" placeholder="Nama Kurikulum" value="<?php echo $jeniskurikulum->Nama ?>">
...
<div class="row form-group">
  ...
  <div class="col-md-8">
  <?php   
       $_na = ($jeniskurikulum->NA == 'Y')? 'checked' : '';
