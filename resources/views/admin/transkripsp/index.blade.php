<p class="text-right">
  <a href="{{ asset('admin/transkripsp/cetaktranskrip/'.$MhswIDplh) }}" target="_BLANK" class="btn btn-success btn-sm">
...
<?php if($krs) { ?>  
<form action="{{ asset('admin/transkripsp/prosessp') }}" method="post" accept-charset="utf-8">
  {{ csrf_field() }}
