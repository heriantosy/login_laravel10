<div class="alert alert-info">
  <p>Hai <strong>{{ Session()->get('nama') }}</strong>, Selamat datang di Halaman Dashboard Mahasiswa</p>
  <p>Mohon kepada Bapak/Ibu Pengguna Sistem Informasi Akademik agar logout setelah menggunakan Sistem</p>
</div>
<hr>
<!-- Info boxes -->
<div class="row">
    ...
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">
          <?php 
          // $mhs = DB::table('mhsw')->where('NA','N')->get(); 
          // echo $mhs->count();
          ?>
          <small>Aktif</small>
        </span>
  ...
  <div class="col-12 col-sm-6 col-md-3">
    <div class="info-box mb-3">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Jadwal Kuliah</span>
        <span class="info-box-number">
        <?php 
  ...
  <div class="col-12 col-sm-6 col-md-3">
    <div class="info-box mb-3">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Jadwal Dosen</span>
        <span class="info-box-number">
        	<?php 
