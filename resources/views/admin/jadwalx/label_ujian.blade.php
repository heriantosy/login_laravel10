...
<form action="{{ asset('admin/jadwalx/proses') }}" method="post" accept-charset="utf-8">
  {{ csrf_field() }}
...
<tbody>
    ...
    <td>
    <a href="{{ asset('admin/jadwalx/labelujian/cetaklbluts/'.$tahunplh.'/'.$prodiplh.'/'.$row->HariID) }}" target="_BLANK"> Cetak Label UTS</a> | 
    <a href="{{ asset('admin/jadwalx/labelujian/cetaklbluas/'.$tahunplh.'/'.$prodiplh.'/'.$row->HariID) }}" target="_BLANK"> Cetak Label UAS</a>
    </td> 
    </tr>
    <?php 
     }
