    ...
    <tr>
      ...
      <td>
        <strong><?php echo strtoupper($jadwalx->NamaDosen) ?>, <?php echo $jadwalx->Gelar ?></strong>
          ...
          <br>Nama Kelas / Waktu: <?php echo $jadwalx->NamaKelas ?>, <?php echo substr($jadwalx->JamMulai,0,5) ?>- <?php echo substr($jadwalx->JamSelesai,0,5) ?> WIB
          <br>Thn Akademik: <?php echo $jadwalx->TahunID ?>
      </td>
    </tr>
	</tbody>
</table>
<form action="{{ asset('admin/jadwalx/simpannilaidosen/'.$jadwalx->JadwalID) }}" enctype="multipart/form-data" method="get" accept-charset="utf-8">
