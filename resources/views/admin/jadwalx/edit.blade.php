...
@endif
<form action="{{ asset('admin/jadwalx/edit_proses') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
 {{ csrf_field() }}
<input type="hidden" name="JadwalID" value="{{ $jadwalx->JadwalID }}">
<input type="hidden" name="TahunID" value="{{ $jadwalx->TahunID }}">
<input type="hidden" name="ProdiID" value="{{ $jadwalx->ProdiID }}">
<input type="hidden" name="ProgramID" value="{{ $jadwalx->ProgramID }}">
      ...
      <?php foreach($tahun as $tahun) { ?>
        <option value="<?php echo $tahun->TahunID ?>" 
          <?php if(isset($_POST['TahunID']) && $_POST['TahunID']==$tahun->TahunID) { echo "selected"; }
                ...
                elseif($tahun->TahunID==$jadwalx->TahunID) { echo 'selected'; } ?>>
      ...
      <?php foreach($program as $program) { ?>
        <option value="<?php echo $program->ProgramID ?>" 
          <?php if(isset($_POST['ProgramID']) && $_POST['ProgramID']==$program->ProgramID) { echo "selected"; }
                ...
                elseif($program->ProgramID==$jadwalx->ProgramID) { echo 'selected'; } ?>>
      ...
      <?php foreach($prodi as $prodi) { ?>
        <option value="<?php echo $prodi->ProdiID ?>" 
          <?php if(isset($_POST['ProdiID']) && $_POST['ProdiID']==$prodi->ProdiID) { echo "selected"; }
                ...
                elseif($prodi->ProdiID==$jadwalx->ProdiID) { echo 'selected'; } ?>>
          <?php echo $prodi->Nama  ?>
        </option>
      <?php } ?>
    </select>
      ...
      <?php foreach($hari as $hari) { ?>
        <option value="<?php echo $hari->HariID ?>" 
          <?php if(isset($_POST['HariID']) && $_POST['HariID']==$hari->HariID) { echo "selected"; }
                ...
                elseif($hari->HariID==$jadwalx->HariID) { echo 'selected'; } ?>>
          <?php echo $hari->Nama  ?>
        </option>
      <?php } ?>
    </select>
...
<div class="row form-group">
  ...
  <div class="col-md-1">
    <input type="text" name="JamMulai" class="form-control form-control-sm" placeholder="Jam Mulai" value="<?php echo $jadwalx->JamMulai ?>">
  </div>s/d
  <div class="col-md-1">
    <input type="text" name="JamSelesai" class="form-control form-control-sm" placeholder="Jam Selesai" value="<?php echo $jadwalx->JamSelesai ?>">
  </div>
</div>
      ...
      <?php foreach($matakuliah as $matakuliah) { ?>
        <option value="<?php echo $matakuliah->MKID ?>" 
          <?php if(isset($_POST['MKID']) && $_POST['MKID']==$matakuliah->MKID) { echo "selected"; }
                ...
                elseif($matakuliah->MKID==$jadwalx->MKID) { echo 'selected'; } ?>>
...
<div class="form-group row">
  ...
  <div class="col-sm-1">
    <input type="text" name="RencanaKehadiran" class="form-control" value="<?php echo $jadwalx->SKS ?>">
  </div>
</div>
      ...
      <?php foreach($ruang as $ruang) { ?>
        <option value="<?php echo $ruang->RuangID ?>" 
          <?php if(isset($_POST['RuangID']) && $_POST['RuangID']==$ruang->RuangID) { echo "selected"; }
                ...
                elseif($ruang->RuangID==$jadwalx->RuangID) { echo 'selected'; } ?>>
          <?php echo $ruang->Nama  ?>
        </option>
      <?php } ?>
    </select>
...
<label class="col-sm-4 control-label text-right">Kapasitas</label>
  <div class="col-md-1">
    <input type="text" name="Kapasitas" class="form-control form-control-sm" placeholder="Kapasitas" required="required" value="<?php echo $jadwalx->Kapasitas ?>">
  </div>
</div>
      ...
      <?php foreach($kelas as $kelas) { ?>
        <option value="<?php echo $kelas->KelasID ?>" 
          <?php if(isset($_POST['KelasID']) && $_POST['KelasID']==$kelas->KelasID) { echo "selected"; }
                ...
                elseif($kelas->KelasID==$jadwalx->NamaKelas) { echo 'selected'; } ?>>
          <?php echo $kelas->Nama  ?>
        </option>
      <?php } ?>
    </select>
      ...
      <?php foreach($dosen as $dosen) { ?>
        <option value="<?php echo $dosen->Login ?>" 
          <?php if(isset($_POST['DosenID']) && $_POST['DosenID']==$dosen->Login) { echo "selected"; }
                ...
                elseif($dosen->Login==$jadwalx->DosenID) { echo 'selected'; } ?>>
...
<div class="form-group row">
  ...
  <div class="col-sm-1">
    <input type="text" name="RencanaKehadiran" class="form-control form-control-sm" value="<?php echo $jadwalx->RencanaKehadiran ?>">
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-sm-1">
    <input type="text" name="KehadiranMin" class="form-control form-control-sm" value="<?php echo $jadwalx->KehadiranMin ?>">
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-sm-8">
    <div class="btn-group">
      ...
      <a href="{{ asset('admin/jadwalx') }}" class="btn btn-success btn-sm">
