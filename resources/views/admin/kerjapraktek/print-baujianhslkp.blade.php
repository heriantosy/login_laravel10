...
<td style="text-align:center;border:none"><b>BERITA ACARA SEMINAR HASIL KERJA PRAKTEK </b></td>
</tr>
</table>     
<br>
<br>
...
<tr style="border:none">
<td style="border:none" width='152'>3. Waktu Ujian</td> <td style="border:none" width='5'>:</td><td style="border:none" width='450'> <?php echo substr($dt->JamMulaiSeminarHasil,0,5) ?> s/d <?php echo substr($dt->JamSelesaiSeminarHasil,0,5) ?> WIB</td>           
</tr>
