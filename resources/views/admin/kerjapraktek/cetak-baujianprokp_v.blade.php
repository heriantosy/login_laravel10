...
<table width="100%">
<tr>
<td align="center"><b>BERITA ACARA SEMINAR PROPOSAL KERJA PRAKTEK </b></td>
</tr>
</table>     
<br>
...
<table>
<tr >
  <td>Pada hari ini,  <?php echo $dayList[$day]?>,  Tanggal <?php echo $tgl ?> Bulan <?php echo $bulList[$bul]?> Tahun <?php echo $thn ?> Telah dilaksanakan Ujian Proposal Kerja Praktek Program Strata-1 (S1),  
...
<table>
<tr valign="top">
<td  valign="top" width='152'>1. Judul</td> <td width='5'>:</td><td width='505'> <?php echo $dt->Judul ?> </td>           
</tr>
...
<tr>
<td width='152'>3. Waktu Ujian</td> <td width='5'>:</td><td width='450'> <?php echo substr($dt->JamMulai,0,5) ?> s/d <?php echo substr($dt->JamSelesai,0,5) ?> WIB</td>           
</tr>
...
<table width='100%'>
  <tr>
    <td style="text-align:center"><u>PANITIA UJIAN</u></td>   
  </tr>
</table>
<br>
...
<table align="center">
  <tr>
    <td align="left" width='152' height=25>Ketua</td>
    <td align="left" width='10'>:</td>
    <td align="left" width='200'><?php echo $Penguji1 ?>, <?php echo $GelarPj1 ?></td>
    <td align="left" width='0'>1. --------------------------------------</td>	
  </tr>

   <tr>
    <td align="left" width='100' height=25>Anggota</td>
    <td align="left" width='10'>:</td>
    <td align="left" width='200'><?php echo $Penguji2 ?>, <?php echo $GelarPj2 ?></td>
    <td align="left" width='0'>2. --------------------------------------</td>
  </tr>

   <tr>
    <td align="left" width='100 height=25'>Anggota</td>
    <td align="left" width='10'>:</td>
    <td align="left" width='200'><?php echo $Penguji3 ?>, <?php echo $GelarPj3 ?></td>
    <td align="left" width='0'>3. -------------------------------------- </td>
