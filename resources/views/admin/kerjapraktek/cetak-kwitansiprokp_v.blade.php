...
for ($i=0; $i<=2; $i++){
    if ($i == 0) {
      ...
      $untuk    = "Honor Penguji Ujian Proposal Kerja Praktek Tahun";
    }elseif ($i == 1) {
...
@include('admin/kop_laporan/kop_lap')
    ...
    <td>Uang sejumlah</td>
    <td>:</td>
    <td>Rp. <?php echo number_format($biaya->Jumlah) ?></td>
    </tr>
    ...
    <center>
      <div style="border:1px solid black; color:red;width:94%;padding:9px;text-align:left">
        <b style="font-size:16px;"><?php echo terbilang($biaya->Jumlah) ?></b>
      </div>
    </center>
    </td>
    </tr>
