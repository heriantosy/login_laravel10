...
<tbody>
    ...
    <?php 
    $i=1; foreach($user as $user) { 
    $id = Crypt::encryptString($user->id_user);    
    ?>
    ...
    <td>
        <div class="btn-group">
        <a href="{{ asset('admin/user/edit/'.$id) }}" 
          class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

          <a href="{{ asset('admin/user/delete/'.$id) }}" class="btn btn-danger btn-sm  delete-link">
