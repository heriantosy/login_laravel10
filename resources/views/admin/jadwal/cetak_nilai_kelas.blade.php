...
<tr style="border:none">
<td style="border:none" colspan=2 >Matakuliah</td> <td style="border:none" colspan=7>: <?php echo $jadwal->NamaProdi ?>  (<?php echo $jadwal->SKS ?> SKS)</td><td style="border:none" colspan=2>Tahun Akademik</td> <td style="border:none" colspan=3>: <?php echo $jadwal->TahunID ?></td>
</tr>
...
<tr >
  ...
  <th width='300' rowspan='3' style="text-align:left;vertical-align:middle;">NAMA MAHASISWA</th>
...
?>
<tr>
	<td height='15' style="text-align:center"> <?php echo $no ?></td>
	<td style="text-align:center" ><?php echo $r->MhswID ?></td>
	<td style="text-align:left"><?php echo $NamaMhs ?> </td>
	<td style="text-align:center" ><?php echo $r->Tugas1 ?></td>
	<td style="text-align:center" ><?php echo $r->Tugas2 ?></td>
	<td style="text-align:center" ><?php echo $r->Tugas3 ?></td>
	<td style="text-align:center" ><?php echo $r->Tugas4 ?></td>
	<td style="text-align:center" ><?php echo $r->Tugas5 ?></td>
	<td style="text-align:center" ><?php echo $r->Tugas5 ?></td>
	<td style="text-align:center" ><?php echo $r->Presensi ?></td>
	<td style="text-align:center" ><?php echo $r->UTS ?></td>
	<td style="text-align:center" ><?php echo $r->UAS ?></td>
	<td style="text-align:center" ><?php echo $r->NilaiAkhir ?></td>
...
<br>Prodi <?php echo $jadwal->NamaProdi ?>
<br>Dosen Pengampu 
<br>
<br>
<br>
